...
def main():
    ...
    parser.add_argument('-cf', '--category_file', help='The directory to read the m3u8 files.')
    args = parser.parse_args()
    parser.add_argument('-mi', '--m3u8_in_dir', help='The directory to read the m3u8 files.')
    args = parser.parse_args()
    parser.add_argument('-mo', '--m3u8_out_dir', help='The directory to store the m3u8 files.')
    args = parser.parse_args()
